        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sản phẩm đang giảm giá</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <div class="container py-5">
        <div class="row">
            @include('user.layouts.products-filter', [
                'actionRoute' => route('products.discounted'),
                                ...
                                <div class="card product-card h-100 border-0 shadow-sm position-relative overflow-hidden">
                                    @if(isset($product->has_discount) && $product->has_discount)
                                        <div class="position-absolute top-0 start-0 p-2 z-index-1">
                                            <span class="badge bg-danger rounded-pill">Sale -{{ number_format($product->discount_percentage ?? 0) }}%</span>
                                        </div>
                                    @endif

                                    <div class="card-img-container position-relative overflow-hidden">
                                        <img src="{{ $product->main_image_url ? $product->main_image_url : asset('images/product1.jpg') }}"
                                    ...
                                    <div class="card-body text-center d-flex flex-column">
                                        ...
                                        <div class="price-section mb-3">
                                            @if(isset($product->has_discount) && $product->has_discount)
                                                <span class="price text-pink fw-bold fs-4">{{ number_format($product->final_price ?? $product->base_price, 0, ',', '.') }}đ</span>
                    ...
                    @elseif(isset($hasFilters) && $hasFilters)
                        <div class="col-12">
                            <div class="text-center py-5">
                                <div class="mb-4">
                                    <i class="bi bi-percent" style="font-size: 4rem; color: #dee2e6;"></i>
                                </div>
                                <h4 class="text-muted mb-3">Không có sản phẩm giảm giá phù hợp</h4>
                            </div>
                        </div>
                    ...
                    @else
                        <div class="col-12">
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-muted mb-3">Hiện không có sản phẩm giảm giá</h4>
                            </div>
                        </div>
                    @endif
                </div>
