    ...
    <div class="container py-5">
        <div class="row">
            ...
            @include('user.layouts.products-filter', [
                'actionRoute' => route('products.search'),
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="fw-bold text-dark mb-0">
                                ...
                                @if(isset($searchTerm) && $searchTerm)
                                    Kết quả tìm kiếm cho: "<span class="text-pink">{{ $searchTerm }}</span>"
                                @else
                                    Tìm kiếm sản phẩm
                                @endif
                            </h4>
                    ...
                    @elseif(isset($searchTerm) && $searchTerm)
                        <div class="col-12">
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-muted mb-3">Không tìm thấy sản phẩm cho từ khóa "{{ $searchTerm }}"</h4>
                            </div>
                        </div>
                    ...
                    @else
                        <div class="col-12">
                            <div class="text-center py-5">
                                ...
                                <h4 class="text-muted mb-3">Nhập từ khóa để tìm kiếm sản phẩm</h4>
                            </div>
                        </div>
                    @endif
                </div>
